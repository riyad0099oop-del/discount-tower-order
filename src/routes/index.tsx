        ...
        <div className="relative mx-auto grid max-w-7xl items-center gap-6 lg:gap-10 px-4 sm:px-6 lg:grid-cols-2 w-full">
          ...
          <div className="relative z-30 flex flex-col justify-center text-center lg:text-start order-2 lg:order-1 lg:pe-8 mt-2 lg:mt-0">
            ...
            <div className="mt-8 lg:mt-10 flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-3 lg:gap-4 animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-300">
              <Button asChild size="lg" className="h-[3.5rem] lg:h-[3.75rem] w-full sm:w-auto rounded-full bg-primary px-8 lg:px-10 text-[1.05rem] lg:text-[1.1rem] font-bold text-white transition-all hover:scale-[1.02] hover:bg-primary/95 shadow-lg shadow-primary/20 border-0">
                <Link to="/menu">اطلب الآن</Link>
              </Button>
              <Button asChild size="lg" variant="outline" className="h-[3.5rem] lg:h-[3.75rem] w-full sm:w-auto rounded-full border-2 border-[#5c4f45]/20 bg-transparent px-8 lg:px-10 text-[1.05rem] lg:text-[1.1rem] font-bold text-[#3c2f25] transition-all hover:bg-[#3c2f25]/5 hover:border-[#3c2f25]/30">
          ...
          <div className="relative z-20 w-full flex justify-center lg:justify-end items-center order-1 lg:order-2">
            ...
            <img
              ...
              fetchPriority="high"
              style={{
                WebkitMaskImage: "radial-gradient(circle closest-side at 50% 50%, black 65%, transparent 95%)",
                maskImage: "radial-gradient(circle closest-side at 50% 50%, black 65%, transparent 95%)"
              }}
        ...
        <section className="relative bg-surface py-12 lg:py-28 overflow-hidden">
          ...
          <div className="relative mx-auto max-w-7xl px-4 sm:px-6 z-10">
            <div className="mb-8 lg:mb-14 text-center lg:text-start">
              <h2 className="text-3xl lg:text-5xl font-black text-foreground tracking-tight">اختيارات البرج</h2>
            </div>
            <div className="grid lg:grid-cols-12 gap-5 lg:gap-8">
              ...
              >
                <div className="relative aspect-[4/3] sm:aspect-[16/10] w-full overflow-hidden bg-cream">
                  <img src={featuredSignature.image} alt={featuredSignature.name} className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" />
                </div>
                <div className="absolute inset-0 bg-gradient-to-t from-cocoa/95 via-cocoa/40 to-transparent flex flex-col justify-end p-6 lg:p-10 text-cocoa-foreground">
                  ...
                  <div className="mt-3 lg:mt-5 flex items-end justify-between">
                    <div>
                      <span className="text-xs sm:text-sm font-bold uppercase tracking-widest text-cocoa-foreground/80">يبدأ من</span>
                      <span className="block text-2xl sm:text-4xl font-black text-primary mt-1">{startingPrice(featuredSignature)}</span>
                    </div>
                    <Button size="lg" className="rounded-full bg-primary text-primary-foreground font-bold shadow-lg shadow-primary/20 hover:scale-105 transition-transform pointer-events-none">
                      اطلب الآن
                    </Button>
                  </div>
                </div>
                  ...
                  >
                    ...
                    <div className="flex flex-1 flex-col justify-center p-5 lg:p-8">
                      ...
                      <div className="mt-3 lg:mt-4 flex items-end justify-between">
                        <div>
                          <span className="text-xs font-bold uppercase tracking-widest text-muted-foreground">يبدأ من</span>
                          <span className="block text-xl lg:text-2xl font-black text-primary mt-1">{startingPrice(p)}</span>
                        </div>
              ...
              return (
                ...
                >
                  ...
                  <div className={`absolute inset-0 bg-gradient-to-t transition-opacity duration-500 ${
                    isActive ? "from-cocoa/70 via-cocoa/10 to-transparent" : "from-cocoa/90 via-cocoa/20 to-transparent opacity-90"
                  }`} />
                  ...
                  <div className="absolute inset-0 flex flex-col items-center justify-center p-8 text-white z-10">
                    <h3 className={`text-3xl sm:text-5xl font-black mb-4 lg:mb-6 drop-shadow-xl transition-transform duration-500 ${isActive ? "scale-110" : ""}`}>{c.name}</h3>
                    <span className={`flex items-center gap-2 rounded-full px-6 lg:px-8 py-3 lg:py-4 text-sm lg:text-base font-bold backdrop-blur-md transition-all duration-300 shadow-xl border ${
                      isActive 
                      ...
                      {isActive ? "اضغط للدخول" : "استكشف"} <ArrowLeft className="size-4 lg:size-5" />
                    </span>
                  </div>
                </Link>
              );
      ...
      <section className="relative bg-surface py-12 lg:py-28 border-y border-border/50 overflow-hidden">
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 z-10">
          <div className="mb-8 lg:mb-12 flex flex-col items-center text-center">
            <h2 className="text-3xl lg:text-5xl font-black text-foreground mb-6 lg:mb-8">من المنيو</h2>
          ...
          <div className="mt-10 lg:mt-14 text-center">
            <Button asChild size="lg" variant="outline" className="h-12 lg:h-14 rounded-full border-foreground/20 px-8 lg:px-10 text-base lg:text-lg font-bold text-foreground hover:bg-foreground/5 hover:border-foreground/40 transition-colors">
              <Link to="/menu" search={{ cat: activeTab }}>عرض المنيو كاملًا</Link>
            </Button>
          </div>
        </div>
      </section>
          ...
          <div className="grid items-center lg:grid-cols-2 gap-8 lg:gap-12 relative z-10">
            <div className="flex flex-col justify-center py-6 lg:py-28 text-center lg:text-start">
              ...
              <div className="mt-8 lg:mt-10">
                <Button asChild size="lg" className="h-14 lg:h-16 rounded-full bg-primary px-10 lg:px-12 text-lg lg:text-xl font-bold text-primary-foreground hover:bg-primary/90 hover:scale-105 transition-transform shadow-xl shadow-primary/20">
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 z-10">
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-20 items-center">
            <div className="order-2 lg:order-1 relative aspect-square max-w-[400px] lg:max-w-[500px] mx-auto w-full">
              ...
              <img src={heroPizza} alt="تحضير البيتزا" className="relative z-10 w-full h-full object-cover rounded-[2rem] lg:rounded-[3rem] -rotate-3 shadow-2xl transition-transform duration-700 hover:rotate-0" />
            </div>
            <div className="order-1 lg:order-2 flex flex-col justify-center text-center lg:text-start">
              <h2 className="text-3xl sm:text-5xl lg:text-6xl font-black text-foreground leading-tight">الفرق يبدأ من التفاصيل</h2>
              <div className="mt-8 lg:mt-12 space-y-6 lg:space-y-10 text-start">
                {[
                  { title: "مكونات طازجة", desc: "نختار الخضروات والأجبان يوميًا بأعلى معايير الجودة لنضمن لك طعماً أصيلاً." },
                  { title: "تحضير يومي", desc: "عجينتنا تُعجن وتُخبز يوميًا، لتصلك هشة، ساخنة ولذيذة في كل طلب." },
                  { title: "خيارات تناسب الجميع", desc: "من البيتزا الكلاسيكية إلى المناقيش المتنوعة، صممنا منيو يرضي كل الأذواق." }
                ].map((item, idx) => (
                  <div key={idx} className="flex flex-row items-start gap-4 lg:gap-6 bg-surface/50 lg:bg-transparent p-4 rounded-2xl lg:p-0 lg:rounded-none border border-border/50 lg:border-none">
                    ...
                    <div className="mt-0">
                      ...
                      <p className="mt-1 lg:mt-2 text-sm lg:text-lg text-muted-foreground leading-relaxed">{item.desc}</p>
                    </div>
                  </div>
                ))}
              </div>
        ...
        <div className="relative mx-auto max-w-5xl px-4 sm:px-6 text-center z-10">
          <div className="rounded-[2.5rem] lg:rounded-[3rem] bg-card border border-border/50 p-8 sm:p-24 shadow-xl relative overflow-hidden">
            ...
            <div className="relative z-10">
              <h2 className="text-3xl sm:text-5xl lg:text-6xl font-black text-foreground">طلبك أقرب مما تتوقع</h2>
              ...
              <Button asChild size="lg" className="mt-8 lg:mt-12 h-14 lg:h-16 rounded-full bg-primary px-12 lg:px-16 text-lg lg:text-xl font-bold text-primary-foreground hover:scale-105 transition-transform shadow-xl shadow-primary/25">
                <Link to="/menu">اطلب الآن</Link>
              </Button>
            </div>
          </div>
